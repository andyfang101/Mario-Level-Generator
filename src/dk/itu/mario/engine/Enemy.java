...
public class Enemy extends Sprite
{
    ...
    //byte enemy representations (for printing out byte representations with the map bytes
    
    public static final byte RED_KOOPA_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte RED_KOOPA_WINGED = (byte) (15 + 1 * 16);
    public static final byte GREEN_KOOPA_WINGLESS = (byte) (15 + 2 * 16);
    public static final byte GREEN_KOOPA_WINGED = (byte) (15 + 3 * 16);
    public static final byte GOOMBA_WINGLESS = (byte) (15 + 4 * 16);
    public static final byte GOOMBA_WINGED = (byte) (15 + 5 * 16);
    public static final byte SPIKY_WINGLESS = (byte) (15 + 6 * 16);
    public static final byte SPIKY_WINGED = (byte) (15 + 7 * 16);
    public static final byte FLOWER_WINGLESS = (byte) (15 + 8 * 16);
    public static final byte FLOWER_WINGED = (byte) (15 + 9 * 16);
  
    /**
    public static final byte RED_KOOPA_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte RED_KOOPA_WINGED = (byte) (15 + 0 * 16);
    public static final byte GREEN_KOOPA_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte GREEN_KOOPA_WINGED = (byte) (15 + 0 * 16);
    public static final byte GOOMBA_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte GOOMBA_WINGED = (byte) (15 + 0 * 16);
    public static final byte SPIKY_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte SPIKY_WINGED = (byte) (15 + 0 * 16);
    public static final byte FLOWER_WINGLESS = (byte) (15 + 0 * 16);
    public static final byte FLOWER_WINGED = (byte) (15 + 0 * 16);
      */
    ...
    {
    	//System.out.println("Enemy collide check!");
        if (deadTime != 0)
        {
            return;
        }
    ...
    @Override
   	public Object clone() throws CloneNotSupportedException{
    	Enemy clone = new Enemy(this.world, (int)this.x/16, (int)this.y/16, this.facing, this.type, this.winged);
